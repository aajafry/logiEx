import { RailSymbol as Vehicle, LucideProps } from "lucide-react";
import {
...
export const procurementManagerMenus: MenuType[] = [
  {
    title: "Vendors",
...
export const fleetManagerMenus: MenuType[] = [
  {
    title: "Vehicles",
...
export const inventoryManagerMenus: MenuType[] = [
  {
    title: "Vendors",
...
export const inventoryInChargeMenus: MenuType[] = [
  {
    title: "Categories",
...
export const CaptainMenus: MenuType[] = [
  {
    title: "Shipments",
