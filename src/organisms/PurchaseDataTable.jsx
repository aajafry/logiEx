...
export const PurchaseDataTable = ({ columns, data }) => {
  ...
  const vendors = [...new Set(data.map((purchase) => purchase.vendor))];
  const inventories = [...new Set(data.map((purchase) => purchase.inventory))];
